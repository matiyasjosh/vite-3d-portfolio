    ...
    <section id="skills" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-gradient-to-br from-slate-700 to-slate-600 rounded-2xl p-6 shadow-xl border border-slate-500 hover:transform hover:scale-105 hover:rotate-2 transition-all duration-500 animate-slide-in-up animation-delay-200 hover:shadow-2xl group">
          ...
          <div className="bg-gradient-to-br from-slate-700 to-slate-600 rounded-2xl p-6 shadow-xl border border-slate-500 hover:transform hover:scale-105 hover:rotate-2 transition-all duration-500 animate-slide-in-up animation-delay-400 hover:shadow-2xl group">
